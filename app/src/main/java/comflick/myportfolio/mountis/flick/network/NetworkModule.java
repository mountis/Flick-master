...
public class NetworkModule {
    ...
    @Provides
    @Singleton
    Api providesTheMovieDbService(Retrofit retrofit) {
        return retrofit.create( Api.class );
    }

    @Provides
    @Singleton
    public MoviesService providesMoviesService(Application application, Api api,
                                               SortHelper sortHelper) {
        return new MoviesService( application.getApplicationContext(), api, sortHelper );
    }
